...
namespace PingPong.Infrastructure.Migrations
{
    ...
    public partial class AddTournaments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchesPlayed = table.Column<int>(
                        type: "integer",
                        nullable: false,
                        defaultValue: 0
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "TournamentFixtures");

            migrationBuilder.DropTable(name: "TournamentParticipants");
