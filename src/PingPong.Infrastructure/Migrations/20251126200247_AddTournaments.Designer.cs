...
namespace PingPong.Infrastructure.Migrations
{
    ...
    [Migration("20251126200247_AddTournaments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PingPong.Domain.Entities.MatchEvent", b =>
                {
                    ...
                    b.HasDiscriminator<string>("EventKind").HasValue("MatchEvent");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("PingPong.Domain.Entities.MatchEventSetEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PingPong.Domain.Entities.Tournament", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PingPong.Domain.Entities.TournamentFixture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TournamentId", "PlayerOneId", "PlayerTwoId")
                        .IsUnique();

                    b.ToTable("TournamentFixtures");
                });

            modelBuilder.Entity("PingPong.Domain.Entities.TournamentParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PingPong.Domain.Entities.OutcomeOnlyMatchEvent", b =>
                {
                    b.HasBaseType("PingPong.Domain.Entities.MatchEvent");

                    b.Property<bool>("PlayerOneWon")
                        .HasColumnType("boolean");

                    b.HasDiscriminator().HasValue("Outcome");
                });

            modelBuilder.Entity("PingPong.Domain.Entities.ScoredMatchEvent", b =>
                {
                    b.HasBaseType("PingPong.Domain.Entities.MatchEvent");

                    b.HasDiscriminator().HasValue("Scored");
                });
            ...
            modelBuilder.Entity("PingPong.Domain.Entities.TournamentFixture", b =>
                {
                    ...
                    b.HasOne("PingPong.Domain.Entities.Tournament", "Tournament")
                        .WithMany("Fixtures")
